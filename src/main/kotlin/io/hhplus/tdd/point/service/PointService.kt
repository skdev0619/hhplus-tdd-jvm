...
class PointService(
    ...
    fun charge(id: Long, amount: Long): PointChargeResponse {
        return lockManager.executeWithLock(id) {
            ...
            val resultPoint = userPointRepository.selectById(id).point.value
            PointChargeResponse(id, TransactionType.CHARGE, amount, resultPoint)
        }
    }
    ...
    fun use(id: Long, amount: Long): PointUseResponse {
        return lockManager.executeWithLock(id) {
            ...
            PointUseResponse(id, TransactionType.USE, amount, resultUserPoint.point.value)
        }
    }
